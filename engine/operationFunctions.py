...
def vecSub(v1, v2):
    return(vec3d(v1[0] - v2[0], v1[1] - v2[1], v1[2] - v2[2]))
def vecMul(v, k):
    return(vec3d(v[0] * k, v[1] * k, v[2] * k))
def vecDiv(v, k):
    return(vec3d(v[0] / k, v[1] / k, v[2] / k))
...
def vecMultMatrix(m, v):
    o = vec3d()
    o[0] = v[0] * m[0][0] + v[1] * m[1][0] + v[2] * m[2][0] + v.w * m[3][0]
    o[1] = v[0] * m[0][1] + v[1] * m[1][1] + v[2] * m[2][1] + v.w * m[3][1]
    o[2] = v[0] * m[0][2] + v[1] * m[1][2] + v[2] * m[2][2] + v.w * m[3][2]
    o.w = v[0] * m[0][3] + v[1] * m[1][3] + v[2] * m[2][3] + v.w * m[3][3]
    return(o)
